...
public final class ShapeState {
  ...
  private final cs3500.animator.provider.model.ShapeType type;
  ...
  public ShapeState(Pos2D p, double width, double height, double r, double g, double b,
      cs3500.animator.provider.model.ShapeType type) {
   ...
   * @param type the type of the shape
   */
  public ShapeState(Pos2D p, cs3500.animator.provider.model.ShapeType type) {
